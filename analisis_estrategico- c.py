...
from areas.ecologia import analizar_ecologia  # <-- AQUÍ ESTABA EL FALLO (IMPORTACIÓN AGREGADA)
...
MAPEO_ANALISIS = {
    ...
    "4_1_ECOLOGIA_Y_MEDIO_AMBIENTE": analizar_ecologia,  # <-- Asegúrate de que esta línea exista tal cual
    ...
    # --- ÁREA: ATENCIÓN CIUDADANA ---
    "ATENCION_CIUDADANA": analizar_atencion_ciudadana,
    "ATENCION CIUDADANA": analizar_atencion_ciudadana,

    # ... tus otras áreas existentes
    "SECRETARIA GENERAL": analizar_secretaria_general,
}
}
